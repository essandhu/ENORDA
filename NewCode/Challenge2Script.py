...
# Used to begin searching process for challenge 2
def challenge2Search(vehicle):
    print("Starting Challenge 2 Search")
    ...
    for point in grid_points:
        ...
        if updated and closest_enemy_id is not None:
            ...
            if closest_enemy_id not in detected_markers:
                ...
                # Update minimum latitude boundary for search grid based on current location (wip)
                # Allows the drone to resume search without backtracking since all ground vehicles will be continously moving forward
...
# Begin challenge 2 search
challenge1Search(copter)
print("Challenge 2 Search Complete")
